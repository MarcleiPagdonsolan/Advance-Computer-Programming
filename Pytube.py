...
#Set Entry
urlEntry    = Entry(root,   font=("Century Gothic", 12), bg= '#D9C6A5', textvariable= getURL, width= 50, bd=3, relief=SUNKEN, borderwidth=1).grid(row=1, column=1, padx=10, pady=10)
browseEntry    = Entry(root,   font=("Century Gothic", 12), bg= '#D9C6A5', textvariable= getLoc, width= 50, bd=3, relief=SUNKEN, borderwidth=1).grid(row=3, column=1, padx=10, pady=10)
 
#Box for video Quality selection
listbox= Listbox(root, font=("Century Gothic", 11), bg= '#D9C6A5', width=56, height=12, bd=3, relief=RAISED, borderwidth=1)
